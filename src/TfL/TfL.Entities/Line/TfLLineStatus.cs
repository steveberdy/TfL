...
namespace TfL.Entities
{
    ...
    public class TfLLineStatus
    {
        ...
        [JsonProperty("statusSeverity")] public int StatusSeverity { get; set; }
        ...
        [JsonProperty("validityPeriods")] public TfLValidityPeriod[] ValidityPeriods { get; set; }
        [JsonProperty("disruption")] public TfLDisruption Disruption { get; set; }
    }
}