...
namespace TfL.Entities
{
    ...
    public class TfLStopPoint
    {
        ...
        [JsonProperty("stationNaptan")] public string StationNaptan { get; set; }
        [JsonProperty("accessibilitySummary")] public string AccessibilitySummary { get; set; }
        [JsonProperty("hubNaptanCode")] public string HubNaptanCode { get; set; }
        [JsonProperty("lines")] public TfLLine[] Lines { get; set; }
        [JsonProperty("lineGroup")] public TfLLineGroup[] LineGroups { get; set; }
        [JsonProperty("lineModeGroups")] public TfLLineModeGroup[] LineModeGroups { get; set; }
        [JsonProperty("fullName")] public string FullName { get; set; }
        [JsonProperty("naptanMode")] public string NaptanMode { get; set; }
        ...
        [JsonProperty("additionalProperties"), JsonConverter(typeof(TfLStopPointPropertyConverter))] public Dictionary<string, string[]> StationServices { get; set; }
        [JsonProperty("children")] public TfLStopPointChild[] Children { get; set; }
