...
namespace TfL.Entities
{
    ...
    {
        [JsonProperty("terminalName")] public string TerminalName { get; set; }
        ...
        [JsonProperty("emptyDocks")] public int EmptyDocks { get; set; }
        [JsonProperty("totalDocks")] public int TotalDocks { get; set; }
        [JsonProperty("brokenDocks")] public int BrokenDocks => TotalDocks - Bikes - EmptyDocks;
